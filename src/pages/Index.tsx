...
const Index = () => {
  ...
  const steps = [{
    ...
    description: "Browse through our verified medical professionals"
  }, {
    step: "02",
    ...
    step: "04",
    title: "Get Token",
    description: "Receive your queue token instantly"
  }];
  const stats = [{
    value: "5000+",
...
 Your Healthcare,  Our Platform  :)o{" "}
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" onClick={() => navigate("/public-booking")} className="text-lg px-8 shadow-medium hover:shadow-large transition-smooth group">
                Book Appointment
      ...
      <section id="how-it-works" className="py-20 bg-gradient-to-b from-background to-primary/5">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {steps.map((item, index) => <motion.div key={index} initial={{
            opacity: 0,
            x: -20
          }} whileInView={{
            opacity: 1,
            ...
            once: true
                ...
                {index < steps.length - 1 && <div className="hidden lg:block absolute top-8 left-[60%] w-[80%] h-0.5 bg-gradient-to-r from-primary to-transparent" />}
              </motion.div>)}
          </div>
        </div>
      </section>
